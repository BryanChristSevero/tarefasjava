...
public interface UpdateUser{}
    ...
    //mapeamento e validação da senha
    ...
    public User(){ //vazio sem argumentos (Obrigatório para o funcionamento do JPA/Hibernate
    ...
    public String getusername(){
        return username; //retorna o valor do usuario
    }

    public void setName(String username){
        this.username = username; //atualizada o valor do usuario
    }

    public String getPassword(){
        return password; //retorna o valor da senha
    }
